...
export default function GalleryCS({}) {
    return (
        <BaseChatSidebar.ChildrenCS childrenCSId="render-img">
            <BaseChatSidebar.Header>
                <ul className="nav justify-content-between align-items-center">
                    ...
                    <li className="text-center d-block ">
                        <h6 className="mb-n2">Gallery</h6>
                        <small className="text-muted">Show Images/Videos</small>
                    </li>
