...
const GroupBlockedUsers = () => {
    const {users, toggleOpenAddUsersModal} = useContext(Group.GroupInfoContext)
    const {allUserOnlineIds, authLayoutData} = useContext(AuthenticatedContext);

    var currentFirstIndexName = null
    return (
        <BaseChatSidebar.ChildrenCS childrenCSId="render-group-blocked-users">
            <BaseChatSidebar.Header>
                <ul className="nav justify-content-between align-items-center">
                    ...
                    <li className="text-center d-block ">
                        <h5 className="text-muted">Blocked Members</h5>
                    </li>
            ...
            <BaseChatSidebar.Body className="h-100">
                <div className="pt-7 pb-4">
                    <div className="container-fluid text-center">
                        <span className="font-weight-bold">Listing Members ({users.length})</span>
                    </div>
                </div>
...
export default GroupBlockedUsers;
